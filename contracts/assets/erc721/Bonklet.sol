...
/**
	...
	@title A minimalistic, gas-efficient ERC-721 implementation forked from the
		`Super721` ERC-721 implementation used by Super Studios.
	@author Tim Clancy <tim-clancy.eth>

	Compared to the original `Super721` implementation that this contract forked
	from, this is a very pared-down contract. This contract includes the gas 
	efficiency techniques graciously shared with the world in the specific 
	ERC-721 implementation by Chiru Labs (https://github.com/chiru-labs/ERC721A).
	...
	ERC165, IERC721, IERC721Metadata, Ownable
{
	...
	*/
	...
	/**
		...
		other addresses as administrators. Administrators may perform mints.
